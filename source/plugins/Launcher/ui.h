...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label_Resolution->Location = System::Drawing::Point(9, 60);
			this->label_Resolution->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label_Resolution->Name = L"label_Resolution";
			this->label_Resolution->Size = System::Drawing::Size(89, 20);
			...
			this->groupBox_ScreenRes->Location = System::Drawing::Point(12, 9);
			...
			this->comboBox_Resolution->Location = System::Drawing::Point(108, 55);
			this->comboBox_Resolution->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->comboBox_Resolution->Name = L"comboBox_Resolution";
			this->comboBox_Resolution->Size = System::Drawing::Size(126, 28);
			...
			this->comboBox_Display->Location = System::Drawing::Point(108, 97);
			this->comboBox_Display->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->comboBox_Display->Name = L"comboBox_Display";
			this->comboBox_Display->Size = System::Drawing::Size(126, 28);
			...
			this->label_Display->Location = System::Drawing::Point(9, 102);
			this->label_Display->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label_Display->Name = L"label_Display";
			this->label_Display->Size = System::Drawing::Size(64, 20);
			...
			this->tabPage_Resolution->Size = System::Drawing::Size(274, 364);
			...
			this->groupBox_InternalRes->Location = System::Drawing::Point(12, 200);
			...
			this->comboBox_intResolution->Location = System::Drawing::Point(108, 86);
			this->comboBox_intResolution->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->comboBox_intResolution->Name = L"comboBox_intResolution";
			this->comboBox_intResolution->Size = System::Drawing::Size(126, 28);
			...
			this->checkBox_InternalRes->Location = System::Drawing::Point(14, 48);
			...
			this->checkBox_InternalRes->Size = System::Drawing::Size(80, 24);
			...
			this->label_intResolution->Location = System::Drawing::Point(9, 91);
			this->label_intResolution->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label_intResolution->Name = L"label_intResolution";
			this->label_intResolution->Size = System::Drawing::Size(89, 20);
			...
			this->tabPage_Patches->Size = System::Drawing::Size(274, 364);
			...
			this->checkBox_HidePVWatermark->Location = System::Drawing::Point(4, 182);
			...
			this->checkBox_HidePVWatermark->Size = System::Drawing::Size(170, 24);
			...
			this->checkBox_HideVolCtrl->Size = System::Drawing::Size(181, 24);
			...
			this->checkBox_HideCredits->Location = System::Drawing::Point(4, 75);
			...
			this->checkBox_HideCredits->Size = System::Drawing::Size(148, 24);
			...
			this->textBox_FPSLimit->Location = System::Drawing::Point(90, 280);
			...
			this->label_FPSLimit->Location = System::Drawing::Point(0, 285);
			...
			this->checkBox_MLAA->Size = System::Drawing::Size(74, 24);
			...
			this->checkBox_TAA->Location = System::Drawing::Point(4, 215);
			this->checkBox_TAA->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->checkBox_TAA->Name = L"checkBox_TAA";
			this->checkBox_TAA->Size = System::Drawing::Size(61, 24);
			...
			this->checkBox_HideStatusIcons->Size = System::Drawing::Size(157, 24);
			...
			this->checkBox_Cursor->Size = System::Drawing::Size(77, 24);
			...
			this->checkBox_Stereo->Size = System::Drawing::Size(78, 24);
			...
			this->tabPage_Components->Size = System::Drawing::Size(274, 364);
			...
			this->checkBox_fps_limiter->Size = System::Drawing::Size(112, 24);
			...
			this->checkBox_scale_component->Size = System::Drawing::Size(157, 24);
			...
			this->checkBox_camera_controller->Size = System::Drawing::Size(158, 24);
			...
			this->checkBox_input_emulator->Size = System::Drawing::Size(135, 24);
			...
			this->checkBox_fast_loader->Size = System::Drawing::Size(116, 24);
			...
			this->checkBox_touch_slider_emulator->Size = System::Drawing::Size(186, 24);
			...
			this->checkBox_stage_manager->Size = System::Drawing::Size(140, 24);
			...
			this->checkBox_touch_panel_emulator->Size = System::Drawing::Size(186, 24);
			...
			this->checkBox_frame_rate_manager->Size = System::Drawing::Size(182, 24);
			...
			this->checkBox_sys_timer->Size = System::Drawing::Size(172, 24);
			...
			this->checkBox_player_data_manager->Size = System::Drawing::Size(179, 24);
			...
			this->pictureBox_Discord->Location = System::Drawing::Point(582, 400);
			this->pictureBox_Discord->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->pictureBox_Discord->Name = L"pictureBox_Discord";
			this->pictureBox_Discord->Size = System::Drawing::Size(63, 63);
